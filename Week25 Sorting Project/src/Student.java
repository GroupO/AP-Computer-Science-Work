...
public class Student
{
	...
	public boolean compareID(Student s)
	{
		if ((Integer.parseInt(s.getName()) > Integer.parseInt(name))) { return true; }
		else { return false; }
	}
	
	//Returns ture if 's' is higher scoring than self.
	public boolean compareScores(Student s)
	{
		if (s.getHighScore() > this.getHighScore()) { return true; }
		else { return false; }
	}
}
